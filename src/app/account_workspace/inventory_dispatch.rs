...
pub(in crate::app) fn apply_dismantle_reward_action(
    ...
    match &mut document.account {
        AccountDocument::Json => crate::app::inventory::apply_dismantle_reward_action(
            &mut document.json,
            location,
            action,
        ),
...
pub(in crate::app) fn remove_character_inventory_items(
    ...
    match &mut document.account {
        AccountDocument::Json => crate::app::inventory::remove_character_inventory_items(
            &mut document.json,
            character_index,
            item_indices,
        ),
...
pub(in crate::app) fn swap_inventory_item_with_equipment(
    ...
    match &mut document.account {
        AccountDocument::Json => crate::app::inventory::swap_inventory_item_with_equipment(
            &mut document.json,
            location,
            slot,
        ),
...
pub(in crate::app) fn move_inventory_item_to_character(
    ...
    match &mut document.account {
        AccountDocument::Json => crate::app::inventory::move_inventory_item_to_character(
            &mut document.json,
            location,
...
pub(in crate::app) fn move_equipment_item_to_inventory(
    ...
    match &mut document.account {
        AccountDocument::Json => crate::app::inventory::move_equipment_item_to_inventory(
            &mut document.json,
            character_index,
            slot,
        ),
