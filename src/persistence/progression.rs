//! Account progression projection, validation and record operations. No UI state.
...
pub(crate) const ACCOUNT_OBJECTIVE_BANK: u8 = 1;
pub(crate) const CHARACTER_OBJECTIVE_BANK: u8 = 2;
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub(crate) struct ProgressionValue {
    pub(crate) definition_index: usize,
    pub(crate) lanes: [i32; 3],
}
...
pub(crate) struct UnlockPolicy {
    pub(crate) account_flag_runs: Vec<FlagRun>,
    pub(crate) profile_flag_runs: Vec<FlagRun>,
    pub(crate) character_flags: Vec<FlagIndex>,
    pub(crate) objective_values: Vec<IndexedValue>,
    pub(crate) character_object_flag_runs: Vec<FlagRun>,
    pub(crate) character_objective_values: Vec<IndexedValue>,
    pub(crate) account_progressions: Vec<ProgressionValue>,
    pub(crate) character_progressions: Vec<ProgressionValue>,
}

#[derive(Debug, Default, PartialEq, Eq)]
pub(crate) struct InvestmentPolicy {
    pub(crate) flag_overrides: Vec<FlagOverride>,
    pub(crate) value_overrides: Vec<ValueOverride>,
}

#[derive(Debug, Default, PartialEq, Eq)]
pub(crate) struct Progression {
    pub(crate) unlocks: UnlockPolicy,
    pub(crate) investment: InvestmentPolicy,
}
...
pub(crate) struct CollectionStateSnapshot {
    ...
    pub(crate) value_overrides: HashMap<usize, i32>,
    pub(crate) account_progressions: Vec<ProgressionValue>,
    pub(crate) character_progressions: Vec<ProgressionValue>,
}
...
pub(crate) fn collection_flag_state_text(
...
pub(crate) fn collection_value_state_text(
    state: &CollectionStateSnapshot,
    definition_index: usize,
    definition: &UnlockDefinition,
) -> String {
...
pub(crate) fn parse(document: &Value) -> Result<Progression, String> {
    Ok(Progression {
...
pub(crate) fn parse_unlocks(value: Option<&Value>) -> Result<UnlockPolicy, String> {
    parse_unlocks_with_policy(value, false)
}

pub(crate) fn parse_document_unlocks(document: &Value) -> Result<UnlockPolicy, String> {
...
pub(crate) fn parse_investment(value: Option<&Value>) -> Result<InvestmentPolicy, String> {
...
pub(crate) fn expanded_flag_slots(rows: &[FlagRun], capacity: usize) -> Vec<usize> {
...
pub(crate) fn compress_flag_slots(slots: &[usize]) -> Vec<FlagRun> {
...
pub(crate) enum InvestmentTable {
    #[default]
    FlagOverrides,
    ValueOverrides,
}
...
impl InvestmentTable {
    pub(crate) const ALL: [Self; 2] = [Self::FlagOverrides, Self::ValueOverrides];
