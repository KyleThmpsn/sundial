...
pub(in crate::persistence::json_account::inventory) fn validate_positive_i32(
    value: i32,
    path: &str,
) -> InventoryResult<()> {
    if value > 0 {
...
pub(in crate::persistence::json_account::inventory) fn validate_nonnegative_i32(
    value: i32,
    path: &str,
) -> InventoryResult<()> {
    if value >= 0 {
...
pub(in crate::persistence::json_account::inventory) fn validate_inventory_definition_hash(
    hash: u32,
    path: &str,
) -> InventoryResult<()> {
...
pub(in crate::persistence::json_account::inventory) fn validate_plug_snapshot(
    plugs: &ItemPlugs,
    path: &str,
) -> InventoryResult<()> {
...
#[cfg(test)]
pub(in crate::persistence::json_account::inventory) fn encode_plugs(plugs: ItemPlugs) -> Value {
    match plugs {
...
#[cfg(test)]
pub(in crate::persistence::json_account::inventory) fn format_definition_hash_hex(
    hash: u32,
) -> String {
    crate::hash::format_hash_hex(u64::from(hash))
}

pub(in crate::persistence::json_account::inventory) fn format_instance_soid(soid: u64) -> String {
    format!("0x{soid:016X}")
}

pub(in crate::persistence::json_account::inventory) fn inventory_item_path(
