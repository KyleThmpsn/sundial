...
pub(in crate::persistence::json_account::inventory) fn validate_known_schema_item_members(
    document: &Value,
    schema_version: u64,
) -> InventoryResult<()> {
...
pub(in crate::persistence::json_account::inventory) fn validate_known_item_members(
...
#[cfg(test)]
pub(in crate::persistence::json_account::inventory) fn character_object_mut(
    document: &mut Value,
...
#[cfg(test)]
pub(in crate::persistence::json_account::inventory) fn ensure_account_object(
    document: &Value,
) -> InventoryResult<()> {
    let state = document
        .get("state")
...
#[cfg(test)]
pub(in crate::persistence::json_account::inventory) fn account_object_mut(
    document: &mut Value,
) -> InventoryResult<&mut Map<String, Value>> {
    document
        .get_mut("state")
...
#[cfg(test)]
pub(in crate::persistence::json_account::inventory) fn profile_array_mut(
    document: &mut Value,
...
#[cfg(test)]
pub(in crate::persistence::json_account::inventory) fn inventory_array_mut(
    document: &mut Value,
    character_index: usize,
) -> InventoryResult<&mut Vec<Value>> {
...
#[cfg(test)]
pub(in crate::persistence::json_account::inventory) fn inventory_object_mut(
    items: &mut [Value],
    item_index: usize,
...
pub(in crate::persistence::json_account::inventory) fn validate_inventory_action(
...
pub(in crate::persistence::json_account::inventory) fn validate_required_account_primary_soid(
    document: &Value,
) -> InventoryResult<()> {
