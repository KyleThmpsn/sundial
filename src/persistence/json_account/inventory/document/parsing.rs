...
pub(in crate::persistence::json_account::inventory) fn dismantle_rarity_values(
    value: &Value,
) -> Vec<DismantleRarity> {
    if let Some(token) = value.as_str() {
        return rarity_from_token(token).into_iter().collect();
    }
    value
        .as_array()
        .into_iter()
...
pub(in crate::persistence::json_account::inventory) fn optional_object_member<'a>(
...
pub(in crate::persistence::json_account::inventory) fn optional_root_object_member<'a>(
    document: &'a Value,
    key: &str,
    path: &str,
) -> InventoryResult<Option<&'a Map<String, Value>>> {
...
pub(in crate::persistence::json_account::inventory) fn parse_profile_item(
    value: &Value,
    index: usize,
...
pub(in crate::persistence::json_account::inventory) fn parse_character_inventory(
    value: &Value,
    character_index: usize,
    mode: SchemaMode,
...
pub(in crate::persistence::json_account::inventory) fn parse_inventory_item(
    value: &Value,
    character_index: usize,
    item_index: usize,
    mode: SchemaMode,
...
pub(in crate::persistence::json_account::inventory) fn validate_existing_character_inventories(
    document: &Value,
    mode: SchemaMode,
) -> InventoryResult<()> {
    let Some(state) = optional_root_object_member(document, "state", "/state")? else {
...
pub(in crate::persistence::json_account::inventory) fn validate_dismantle_rewards(
    document: &Value,
    mode: SchemaMode,
) -> InventoryResult<()> {
...
fn rarity_from_token(token: &str) -> Option<DismantleRarity> {
    match token {
        "common" => Some(DismantleRarity::Common),
        "uncommon" => Some(DismantleRarity::Uncommon),
        "rare" => Some(DismantleRarity::Rare),
        "legendary" => Some(DismantleRarity::Legendary),
        "exotic" => Some(DismantleRarity::Exotic),
        _ => None,
    }
}

pub(in crate::persistence::json_account::inventory) fn validate_dismantle_rarity(
    value: &Value,
    path: &str,
) -> InventoryResult<u8> {
...
pub(in crate::persistence::json_account::inventory) fn character_object(
    document: &Value,
    character_index: usize,
...
pub(in crate::persistence::json_account::inventory) fn parse_hash_field(
...
pub(in crate::persistence::json_account::inventory) fn parse_nonzero_soid(
    value: &Value,
    path: &str,
) -> InventoryResult<u64> {
...
pub(in crate::persistence::json_account::inventory) fn parse_nonnegative_i32_field(
    object: &Map<String, Value>,
    key: &str,
    base_path: &str,
) -> InventoryResult<i32> {
...
pub(in crate::persistence::json_account::inventory) fn parse_positive_i32_field(
    object: &Map<String, Value>,
    key: &str,
    base_path: &str,
) -> InventoryResult<i32> {
...
pub(in crate::persistence::json_account::inventory) fn parse_plugs(
    value: &Value,
    path: &str,
...
pub(in crate::persistence::json_account::inventory) fn parse_flags(
    value: &Value,
    path: &str,
    flag_mask: u8,
) -> InventoryResult<u8> {
