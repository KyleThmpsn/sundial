...
pub(in crate::persistence::json_account::inventory) fn validate_unique_soids(
    document: &Value,
) -> InventoryResult<()> {
...
pub(in crate::persistence::json_account::inventory) fn visit_soids(
    document: &Value,
...
pub(in crate::persistence::json_account::inventory) fn visit_equipment_soids(
...
pub(in crate::persistence::json_account::inventory) fn visit_inventory_soids(
    character: &Map<String, Value>,
    character_index: usize,
    visit: &mut impl FnMut(u64, &str) -> InventoryResult<()>,
) -> InventoryResult<()> {
