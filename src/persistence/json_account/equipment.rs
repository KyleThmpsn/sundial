...
pub(crate) struct EquippedItemSnapshot {
    pub slot: &'static str,
...
#[derive(Clone, Debug, PartialEq, Eq)]
pub(crate) enum EquippedItemPlugs {
    NativeDefaults,
...
#[derive(Clone, Debug, PartialEq, Eq)]
pub(crate) enum EquippedPlugValue {
    Empty,
    Hash(u64),
    Malformed(String),
}
...
impl EquippedItemPlugs {
    ...
    pub(crate) fn display_value(&self) -> Option<Value> {
        match self {
...
pub(crate) fn equipped_item_snapshots(
    document: &Value,
...
pub(crate) fn field_display_text(value: Option<&Value>) -> String {
    match value {
...
pub(crate) fn domain_default_plugs(
...
pub(crate) fn equipment_character_id(
...
pub(crate) fn equipment_item_target_error(slot: &str) -> String {
    format!(
...
pub(crate) fn load_existing_equipment_item(
    document: &Value,
    character_index: usize,
    slot: &str,
...
pub(crate) fn apply_equipment_command(
    document: &mut Value,
    adapter: JsonCharacterAdapter,
...
pub(crate) fn set_equipment_item_level(
    document: &mut Value,
    character_index: usize,
    slot: &str,
    level: i64,
...
pub(crate) fn set_equipment_item_plug(
    document: &mut Value,
    character_index: usize,
    slot: &str,
    socket_index: usize,
...
pub(crate) fn set_equipment_item_flags(
    document: &mut Value,
    character_index: usize,
    slot: &str,
    flags: Option<u8>,
...
pub(crate) fn set_weapon_slot_empty(
    document: &mut Value,
    character_index: usize,
    slot: &str,
) -> Result<(), String> {
...
pub(crate) fn default_plug_values(defaults: &[Option<String>]) -> Vec<Value> {
    defaults
        .iter()
...
pub(crate) fn inferred_item_level(document: &Value, character_index: usize) -> i64 {
    document
        .pointer("/state/characters")
...
#[cfg(test)]
pub(crate) fn materialize_authored_plugs<'a>(
    plugs: &'a mut Value,
