...
pub(crate) struct PreparedSettings {
    ...
    pub(crate) size_limit_bytes: usize,
...
pub(crate) fn settings_size_limit_for_schema(schema: Option<u64>) -> usize {
...
pub(crate) fn prepare_settings(document: &Value) -> Result<PreparedSettings, String> {
...
pub(crate) fn encode_settings(document: &Value) -> Result<String, String> {
